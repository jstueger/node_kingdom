import { BUILDINGS, activeRecipe, inputPorts, outputPort } from './data.js?v=world-1';
import { inputAccepts, inputResourceForStorage, recipeTimeFor, salePriceFor, storageCapFor } from './rules.js?v=world-1';
